...
---
<!--
	Entries are in html for unique content layout.
	To create entries, select any previous entry, copy and paste it below this comment (above previous entries), and change the information as needed.
	A good improvement of this page would be to add `toc: true` to the header and find a nice way to layout the information so that the date makes it into the `<h3>` (even if it's fonted smaller within that block).
-->
...
<h3 style='display:inline'>Astronomy on Tap #5</h3><font size="+1">- Revolution Bar, Bryan, TX</font>
...
<h3 style='display:inline'>Star Party</h3><font size="+1">- Ledbetter, TX</font>
...
<h3 style='display:inline'>Astronomy on Tap #1</h3><font size="+1">- Revolution Bar, Bryan, TX</font>
...
<h3 style='display:inline'>Transit of Venus</h3><font size="+1">- in front of MSC, Texas A&M University</font>
